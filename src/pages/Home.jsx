...
export default function Home() {
    ...
    return (
        <div
            className="min-h-screen bg-[linear-gradient(360deg,hsla(216,82%,24%,1)_0%,hsla(225,100%,6%,1)_100%)] "
        >
            <div className="p-4">
                <Navbar />
            </div>
            ...
            <div className="flex justify-center items-center">
                <div
                    className={`transition-all duration-1000 ease-in-out ${show ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
                        }`}
                >
                    <img src="src/assets/group1.svg" alt="group1" className="w-full h-full" />
                </div>
                ...
                >
                    <img src="src/assets/group2.svg" alt="group2" className="w-full h-full" />
                </div>
            </div>
        </div>
    );
