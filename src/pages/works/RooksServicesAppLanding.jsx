...
import tmsimg from "../../assets/mobile_apps_asstes/rooks service app/phone.png";
import playStoreImage from "../../assets/mobile_apps_asstes/rooks service app/play store downold.png";
import MultiUserRoleSystem from "../../assets/mobile_apps_asstes/rooks service app/Multi-User Role System.png";
import TicketManagement from "../../assets/mobile_apps_asstes/rooks service app/Ticket Management.png";
import BarcodeSystem from "../../assets/mobile_apps_asstes/rooks service app/Barcode System.png";
import SmartReportGenerationSystem from "../../assets/mobile_apps_asstes/rooks service app/Smart Report Generation System.png";
import RealTimeAnalyticsEngine from "../../assets/mobile_apps_asstes/rooks service app/Real-Time Analytics Engine.png";
import GETSTARTED from "../../assets/mobile_apps_asstes/rooks service app/GET STARTED.png";
import LOGIN from "../../assets/mobile_apps_asstes/rooks service app/LOGIN  SIGN UP.png";
import CREATEMANAGE_TICKETS from "../../assets/mobile_apps_asstes/rooks service app/Create & Manage Tickets.png";
import COMPLETE_SERVICE from "../../assets/mobile_apps_asstes/rooks service app/completion screen.png";
import REAL_TIME_UPDATES from "../../assets/mobile_apps_asstes/rooks service app/REAL-TIME UPDATES (Large Card).png";
import MULTI_PLATFORM_SUPPORT from "../../assets/mobile_apps_asstes/rooks service app/Multi-PLATFORM SUPPORT (Small Card).png";
import PROFESSIONAL_REPORTS from "../../assets/mobile_apps_asstes/rooks service app/PROFESSIONAL REPORTS (Small Card).png";
import SECURE_RELIABLE from "../../assets/mobile_apps_asstes/rooks service app/SECURE & RELIABLE (Large Card).png";
import SERVICE_CUSTOMERS_SMALL from "../../assets/mobile_apps_asstes/rooks service app/SERVICE CUSTOMERS.png";
import AMC_CUSTOMERS from "../../assets/mobile_apps_asstes/rooks service app/AMC CUSTOMERS.png";
import SERVICE_MANAGERS from "../../assets/mobile_apps_asstes/rooks service app/SERVICE MANAGERS.png";
import SERVICE_ENGINEERS from "../../assets/mobile_apps_asstes/rooks service app/SERVICE ENGINEERS.png";
import BUSINESSES from "../../assets/mobile_apps_asstes/rooks service app/BUSINESSES.png";
import MODERN_ARCHITECTURE from "../../assets/mobile_apps_asstes/rooks service app/modern architecture.png";
        ...
        {chars.map((char, i) => {
          ...
          return (
            ...
            >
              {/* Mobile */}
              <span
                className="block md:hidden text-[10px]"
                style={{
                  transform: `translate(-50%, -50%) rotate(${angle * (180 / Math.PI)}deg) translateY(-140px)`,
                }}
              >
                {char === " " ? "\u00A0" : char}
              </span>
              ...
              <span
                ...
                style={{
                  transform: `translate(-50%, -50%) rotate(${angle * (180 / Math.PI)}deg) translateY(-170px)`,
                }}
              >
                {char === " " ? "\u00A0" : char}
              </span>
...
const FEATURES = [
  ...
  },
  {
    ...
    image: SmartReportGenerationSystem,
    subFeatures: [
      "PDF Generation",
      "Report Printing",
      ...
      <div className="min-h-screen bg-[#050a15] text-white font-['Inter'] overflow-x-hidden relative selection:bg-[#0B3470]/30">
        ...
        >
          ...
          <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center py-10 w-full">
            ...
            >
              <Chip className="mb-2">
                <Sparkles size={14} className="text-[#0B3470]" /> Next-Gen
                Service Management
              </Chip>
            ...
            {/* Right: Premium Animated Showcase */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={isHeroInView ? { opacity: 1, x: 0 } : {}}
            ...
            >
              ...
              <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(11,52,112,0.3)_0%,transparent_70%)]"></div>

                {/* Blue Glow Behind Phone */}
                <div className="absolute w-[350px] h-[350px] bg-[#0B3470]/40 rounded-full blur-3xl"></div>

                {/* Floating Particles */}
                {[...Array(12)].map((_, i) => (
                  <motion.div
                    key={i}
                    className="absolute w-2 h-2 bg-[#0B3470] rounded-full opacity-60"
                    initial={{
                    ...
                    animate={{
                      y: [
                        null,
                        Math.sin((i * 30 * Math.PI) / 180) * 200 - 20,
                        null,
                      ],
                      opacity: [0.3, 0.8, 0.3],
                    }}
                ...
                <motion.div
                  className="absolute w-[360px] h-[360px] md:w-[450px] md:h-[450px] z-10"
                  animate={{ rotate: 360 }}
                  transition={{
                    duration: 25,
                    repeat: Infinity,
                ...
                >
                  <CircularText text="Instant Request Submission • Real-Time Tracking • Fast, Reliable & Transparent Communication • Warranty & Service History •" />
                </motion.div>
                ...
                {/* Floating Widget Cards (Preserved) */}
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.6 }}
                  className="absolute -top-6 -right-2 md:-top-8 md:-right-8 bg-[#0a1a3a]/95 backdrop-blur-xl border border-[#0B3470]/30 rounded-2xl p-3 md:p-4 shadow-xl z-30"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#0B3470]/20 flex items-center justify-center">
                      <Check size={18} className="text-[#0B3470]" />
                    </div>
                    <div>
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-2 md:-bottom-6 md:-left-8 bg-[#0a1a3a]/95 backdrop-blur-xl border border-[#10B981]/30 rounded-2xl p-2 md:p-3 shadow-xl z-30"
                >
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#10B981]/20 flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="absolute top-1/2 -right-0 md:-right-12 -translate-y-1/2 bg-[#0a1a3a]/95 backdrop-blur-xl border border-[#8B5CF6]/30 rounded-xl p-2 md:p-3 shadow-xl z-30 hidden md:block"
                >
                  <div className="flex flex-col items-center gap-1">
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#8B5CF6]/20 flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Explore how Rooks Services App transforms service management
                with intelligent, role-based tools.
              </p>
            </div>
        ...
        <section
          id="designed-for"
          className="py-24 px-4 sm:px-6 bg-gradient-to-b from-[#050a15] to-[#0a1020]"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
                ...
                {[
                  {
                    ...
                    title: "Flutter",
                    desc: "Cross-platform UI framework with native performance",
                  },
                  {
                    icon: <Cloud size={20} />,
                    title: "Firebase",
                    desc: "Auth, Firestore, Storage, and Cloud Messaging",
                  },
                  {
                    icon: <Bell size={20} />,
                    title: "FCM Notifications",
                    desc: "Push notifications for real-time updates",
                  },
                  {
                    icon: <Layers3 size={20} />,
                    title: "Provider State",
                    desc: "Efficient state management across the app",
                  },
                ].map((tech, i) => (
                  <motion.div
                    key={i}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{
                    scale: 1.05,
                    backgroundColor: `rgba(11,52,112,0.15)`,
                  }}
        ...
        <section id="cta" className="py-32 px-4 relative">
          <div className="max-w-6xl mx-auto relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative overflow-hidden bg-gradient-to-br from-[#0B3470] via-[#1a5a9a] to-[#0B3470] p-8 md:p-12 rounded-3xl shadow-2xl shadow-[#0B3470]/30"
            >
              {/* Animated background */}
              <div className="absolute inset-0">
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="mb-8 text-xl text-white/90">
                    ...
                    today and transform your service operations.
                  </p>
                ...
                <div className="md:w-1/2 bg-[#1a1f2e] flex flex-col items-center justify-center p-12 relative overflow-hidden border-r border-white/10">
                  ...
                  <div className="mt-8 text-center relative z-10 w-full">
                    ...
                    <p className="text-gray-400 text-sm max-w-[240px] mx-auto italic">
                      "Streamlining service operations with powerful
                      simplicity."
                    </p>
                  </div>
                    ...
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-400 mb-8">
                          Ready to streamline your service operations? Let's
                          discuss your needs.
                        </p>
