    ...
    return (
        <div className="min-h-screen bg-[#071324] text-white overflow-hidden font-sans">
            ...
            <div className="fixed right-6 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-3">
                {["Hero", "Features", "About", "Process", "Analytics", "CTA"].map((_, i) => (
                    <div
                        key={i}
            ...
            <section ref={heroRef} className="relative min-h-screen flex items-center">
                ...
                <div className="absolute inset-0">
                    ...
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(115deg, #071324 55%, #0B3470 55%)",
                        }}
                    />
                    ...
                    <div className="grid lg:grid-cols-12 gap-0 items-center min-h-[80vh]">
                        ...
                        >
                            ...
                            >
                                ...
                                <h1 className="text-[clamp(3rem,8vw,6rem)] font-black leading-[0.9] tracking-tight mb-2 text-transparent"
                            ...
                            >
                                A dedicated application for Krishna Bhagtha Seva Trust — managing
                                donations, expenses, and generating accurate financial reports with
                            ...
                            >
                                ...
                                <button className="group flex items-center gap-3 text-sm font-bold uppercase tracking-wider text-gray-400 hover:text-white transition-colors">
                                    <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:border-[#4ec9ff] transition-colors">
                                        <Play className="w-3 h-3 ml-0.5 group-hover:text-[#4ec9ff] transition-colors" />
                                    </div>
                                    Watch Demo
                                </button>
                            </motion.div>
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <span className="text-xs uppercase tracking-wider text-gray-400">Total Donations</span>
                                    <span className="text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full">+23% ↑</span>
                                </div>
                                <div className="text-4xl font-black text-white mb-4">₹1.0L</div>
                                {/* Mini bar chart */}
                                <div className="flex items-end gap-1.5 h-14">
                                    {[40, 60, 45, 80, 55, 90, 70, 95, 65, 85, 75, 100].map((h, i) => (
                                        <motion.div
                                            key={i}
                                            initial={{ scaleY: 0 }}
                            ...
                            >
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-xs font-bold text-[#4ec9ff]">Fund Allocation</span>
                                </div>
                                {[
                            ...
                            >
                                ...
                                <p className="text-xs text-gray-300">New donation received: <strong className="text-white">₹5,200</strong></p>
            ...
            <div className="py-4 bg-[#0B3470] overflow-hidden border-y border-[#1e4a8a]">
                ...
                >
                    {[...Array(2)].map((_, ri) =>
                        ["Donation Tracking", "Expense Management", "Receipt Generation", "Admin Dashboard", "Devotee Portal", "Financial Reports", "Category Management", "PDF Export"].map((t, i) => (
                            <span key={`${ri}-${i}`} className="text-xs uppercase tracking-[0.3em] text-white/60 flex items-center gap-4">
                        ...
                        <div className="lg:col-span-4 lg:sticky lg:top-24">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 mb-6">
                                    <div className="w-8 h-[2px] bg-[#4ec9ff]" />
                                    <span className="text-[#4ec9ff] text-xs font-bold uppercase tracking-[0.3em]">Features</span>
                                </div>
                                <h2 className="text-5xl font-black leading-tight mb-6">
                                    Everything<br />You Need<br />
                                    <span className="text-transparent" style={{ WebkitTextStroke: "2px #0B3470" }}>to Manage</span>
                                </h2>
                                <p className="text-gray-400 text-base leading-relaxed">
                                    One platform for the complete financial lifecycle of Krishna Bhagtha Seva Trust.
                                </p>
                                <motion.button
                                    whileHover={{ x: 4 }}
                                    className="mt-8 flex items-center gap-2 text-[#4ec9ff] text-sm font-bold uppercase tracking-wider group"
                                >
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <h3 className="font-black text-xl group-hover:text-[#4ec9ff] transition-colors">{item.title}</h3>
                                        </div>
                                        <p className="text-gray-500 text-sm leading-relaxed mb-3">{item.desc}</p>
                                        <div className="flex gap-2 flex-wrap">
                                            {item.tags.map((tag, ti) => (
                                                <span key={ti} className="text-[10px] uppercase tracking-wider border border-[#0B3470]/50 text-[#4ec9ff]/60 px-2 py-0.5 rounded group-hover:border-[#4ec9ff]/30 transition-colors">
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
                                    </div>
                                    <ArrowRight className="w-4 h-4 text-gray-700 group-hover:text-[#4ec9ff] group-hover:translate-x-1 transition-all shrink-0 mt-2" />
                                </motion.div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="bg-gradient-to-br from-[#0B3470] to-[#071324] rounded-3xl p-10 border border-[#0B3470]/50 relative overflow-hidden">
                                ...
                                <p className="text-gray-400 leading-relaxed mb-8">
                                    The Charity Application is built to make managing donations and expenses simple
                                    and stress-free for Krishna Bhagtha Seva Trust — replacing paperwork with a
                                    secure, transparent digital system.
                                </p>
                            ...
                            >
                                ...
                                <div className="text-xs font-bold uppercase tracking-wider opacity-70">Transparent</div>
                            </motion.div>
                        </motion.div>
                        ...
                        >
                            <div className="inline-flex items-center gap-2 mb-8">
                                <div className="w-8 h-[2px] bg-[#4ec9ff]" />
                                <span className="text-[#4ec9ff] text-xs font-bold uppercase tracking-[0.3em]">About Us</span>
                            </div>
                            <h2 className="text-5xl font-black leading-tight mb-6">
                                Designed for{" "}
                            ...
                            <p className="text-gray-400 leading-relaxed mb-10">
                                We believe every donated rupee deserves accountability. This application gives
                                Krishna Bhagtha Seva Trust the tools to operate with clarity — from the first
                                donation entry to the final financial report.
                            </p>

                            {/* 2x2 icon grid */}
                            <div className="grid grid-cols-2 gap-4 mb-10">
                                {[
                                    { icon: DollarSign, label: "Devotee Portal", sub: "Easy donation & expense entry" },
                                    { icon: Smartphone, label: "Mobile-Ready", sub: "Access from any device" },
                                    { icon: ShieldCheck, label: "Secure Records", sub: "All data stored safely" },
                            ...
                            <motion.button
                                whileHover={{ x: 4 }}
                                className="flex items-center gap-2 text-[#4ec9ff] text-sm font-black uppercase tracking-wider group"
                            >
                                Learn More
                                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </motion.button>
            ...
            <section className="py-28 px-6 lg:px-12 relative overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 mb-6">
                            <div className="w-8 h-[2px] bg-[#4ec9ff]" />
                            <span className="text-[#4ec9ff] text-xs font-bold uppercase tracking-[0.3em]">Process</span>
                        </div>
                        <h2 className="text-5xl font-black leading-tight">
                            How It Works in{" "}
                            <span className="text-[#4ec9ff]">5 Steps</span>
                        </h2>
                    </motion.div>
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-4">
                            {[
                                { step: "01", label: "Select Login Role", icon: Layout, desc: "Choose Trust Admin or Devotee login to access your dashboard" },
                                { step: "02", label: "Record Donations", icon: DollarSign, desc: "Enter donor name, category, amount, and generate instant PDF receipts" },
                                { step: "03", label: "Log Expenses", icon: BarChart3, desc: "Add expense details with category, receiver, and date for full accountability" },
                                { step: "04", label: "Manage Categories", icon: PieChart, desc: "Admin configures income and expense categories like Annadhanam, Medical Camp" },
                                { step: "05", label: "Generate Reports", icon: FileText, desc: "Export income, expense, or overall PDF reports filtered by day, month, or year" },
                            ].map((item, i) => {
                                const Icon = item.icon;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="text-center">
                                            <div className={`text-xs font-black uppercase tracking-wider mb-1 transition-colors ${isActive ? "text-[#4ec9ff]" : "text-gray-600"}`}>
                                                Step {item.step}
                                            </div>
                                            <h3 className={`font-black text-lg mb-2 transition-colors ${isActive ? "text-white" : "text-gray-300"}`}>
                                                {item.label}
                                            </h3>
                                            <p className={`text-xs leading-relaxed max-w-[160px] mx-auto transition-colors ${isActive ? "text-gray-300" : "text-gray-600"}`}>
                                                {item.desc}
                                            </p>
                                        </div>
                                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <div>
                            <div className="inline-flex items-center gap-2 mb-6">
                                <div className="w-8 h-[2px] bg-[#4ec9ff]" />
                                <span className="text-[#4ec9ff] text-xs font-bold uppercase tracking-[0.3em]">Analytics</span>
                            </div>
                            <h2 className="text-5xl font-black leading-tight">
                                Powerful Insights<br />&{" "}
                                <span className="text-[#4ec9ff]">Accountability</span>
                            </h2>
                        </div>
                        <p className="text-gray-400 max-w-xs leading-relaxed text-sm">
                            Make informed decisions with real-time financial data, detailed donor records, and comprehensive trust analytics.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-black mb-2">Annual Donation Growth</h3>
                            <p className="text-gray-400 text-sm mb-6">Year-over-year donor contributions and trust fund growth metrics</p>
                            {/* Fake line chart */}
                            <div className="relative h-32">
                                <svg viewBox="0 0 300 100" className="w-full h-full" preserveAspectRatio="none">
                                    ...
                                    <path d="M0,80 C50,70 80,50 120,40 C160,30 200,55 250,20 L300,15" fill="none" stroke="#4ec9ff" strokeWidth="2" />
                                    <path d="M0,80 C50,70 80,50 120,40 C160,30 200,55 250,20 L300,15 L300,100 L0,100 Z" fill="url(#lineGrad)" />
                                </svg>
                            </div>
                            <div className="mt-4 flex gap-6">
                                <div>
                                    <div className="text-2xl font-black text-[#4ec9ff]">+34%</div>
                                    <div className="text-[10px] text-gray-500 uppercase tracking-wider">YoY Growth</div>
                                </div>
                                <div>
                        ...
                        {/* Small cards */}
                        {[
                            { title: "Annadhanam Fund", val: "Active", icon: BarChart3, color: "#4ec9ff" },
                            { title: "Expense Categories", val: "Custom", icon: PieChart, color: "#4ec9ff" },
                            { title: "Financial Transparency", val: "A+", icon: ShieldCheck, color: "#4ec9ff" },
                            { title: "PDF Report Export", val: "Instant", icon: FileText, color: "#4ec9ff" },
                            { title: "Referral Tracking", val: "Enabled", icon: CheckCircle2, color: "#4ec9ff" },
                            { title: "Report Periods", val: "3 Types", icon: Globe, color: "#4ec9ff" },
                        ].map((item, i) => {
                            const Icon = item.icon;
                            return (
                                <motion.div
            ...
            <section className="py-28 px-6 lg:px-12 relative overflow-hidden">
                ...
                <div
                    className="absolute inset-0 opacity-[0.03]"
                    style={{
                        backgroundImage: "linear-gradient(45deg, #4ec9ff 1px, transparent 1px), linear-gradient(-45deg, #4ec9ff 1px, transparent 1px)",
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 mb-8">
                                <div className="w-8 h-[2px] bg-[#4ec9ff]" />
                                <span className="text-[#4ec9ff] text-xs font-bold uppercase tracking-[0.3em]">Get Started</span>
                            </div>
                            <h2 className="text-6xl font-black leading-tight mb-6">
                                Empower Your<br />Trust with{" "}
                                <span className="text-[#4ec9ff]">Clarity</span>
                            </h2>
                            <p className="text-gray-400 text-lg leading-relaxed mb-10">
                                Replace manual records with a smart charity management system built for
                                transparency and accountability. Trusted by Krishna Bhagtha Seva Trust.
                            </p>
                            ...
                            <div className="flex gap-4 flex-wrap">
                                ...
                                <button className="px-8 py-4 border border-white/20 font-bold text-sm uppercase tracking-wider hover:border-[#4ec9ff] hover:text-[#4ec9ff] transition-all">
                                    Book Demo
                                </button>
                            </div>
                            ...
                            <div className="mt-10 flex gap-8 text-sm text-gray-500">
                                <span className="flex items-center gap-2">
                                    <Shield className="w-4 h-4 text-[#0B3470]" /> Secure & Reliable
                                </span>
                                <span className="flex items-center gap-2">
                                    <Award className="w-4 h-4 text-[#0B3470]" /> Built for Charitable Trusts
                                </span>
                            </div>
                        </motion.div>
                        ...
                        >
                            {[
                                ...
                                { label: "Income & expense category management", checked: true },
            ...
            <footer className="border-t border-white/5 py-12 px-6 lg:px-12">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-gray-500 text-xs relative z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-black text-white text-sm uppercase tracking-wider">Krishna Bhagtha Seva Trust</span>
                    </div>
                    <div className="uppercase tracking-widest">© 2024 Rooks & Brooks Technologies Pvt Ltd. All rights reserved.</div>
                    <div className="flex gap-8 uppercase tracking-widest">
                        {["Privacy", "Terms", "Contact"].map((l) => (
                            <a key={l} href="#" className="hover:text-[#4ec9ff] transition-colors">{l}</a>
                        ))}
                    </div>
                </div>
            </footer>
