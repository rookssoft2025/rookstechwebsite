  ...
  return (
    <div>
      <div className="relative bg-[#071730] px-4 sm:px-6 lg:px-15 overflow-hidden pb-10 min-h-screen">
        ...
        >
          <div className="absolute top-[10%] left-[10%] w-1 h-1 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'0s'}}></div>
          <div className="absolute top-[25%] left-[75%] w-0.5 h-0.5 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'1.5s'}}></div>
          <div className="absolute top-[40%] left-[30%] w-1 h-1 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'0.7s'}}></div>
          <div className="absolute top-[60%] left-[60%] w-0.5 h-0.5 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'2.2s'}}></div>
          <div className="absolute top-[80%] left-[20%] w-1 h-1 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'1s'}}></div>
          <div className="absolute top-[15%] left-[50%] w-0.5 h-0.5 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'0.5s'}}></div>
          <div className="absolute top-[70%] left-[85%] w-1 h-1 bg-[#65a6db] rounded-full animate-pulseStar" style={{animationDelay:'1.8s'}}></div>
        </div>
